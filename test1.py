...
class Test(unittest.TestCase):
	...
	def test1(self):
		self.assertEqual(welcome_text_elt, "Поздравляем! Вы успешно зарегистировались!", 'Error Registration 1')
	    #self.assertEqual(welcome_text_elt,welcome_text,"Сообщение")
		...
		button = browser.find_element_by_xpath("//input[@placeholder='Введите адрес:']")
		button.click()
